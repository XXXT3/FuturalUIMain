...
local SHADOW_TRANSPARENCY = 0.75
local ACCENT_COLOR = Color3.fromRGB(90, 140, 240)
local BACKGROUND_COLOR = Color3.fromRGB(25, 30, 40)
local SECTION_COLOR = Color3.fromRGB(35, 40, 50)
local TEXT_COLOR = Color3.fromRGB(240, 240, 240)
local SUBTEXT_COLOR = Color3.fromRGB(180, 180, 180)
local ELEMENT_COLOR = Color3.fromRGB(45, 50, 60)
local HOVER_COLOR_LIGHT = Color3.fromRGB(60, 65, 75)
local HOVER_COLOR_DARK = Color3.fromRGB(40, 45, 55)
...
function FuturaUI:AddDropdown(sectionName, text, options, default, callback)
    ...
    dropdownFrame.Parent = section.contentFrame
    ...
    dropdownButton.MouseButton1Click:Connect(function()
        ...
        if expanded then
            ...
            TweenService:Create(optionsFrame, TweenInfo.new(0.2), {Size = UDim2.new(1, 0, 0, optionsList.AbsoluteContentSize.Y + 10)}):Play()
        else
            TweenService:Create(optionsFrame, TweenInfo.new(0.2), {Size = UDim2.new(1, 0, 0, 0)}):Play()
            delay(0.2, function()
